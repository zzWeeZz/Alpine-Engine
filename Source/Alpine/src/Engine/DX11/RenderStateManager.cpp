...
void Alpine::RenderStateManager::Initialize()
{
	...
	blendDesc.RenderTarget[0] = renderTargetBlendDesc;
	DX11::Device()->CreateBlendState(&blendDesc, &m_BlendStates[BlendMode::NoBlend]);
...
void Alpine::RenderStateManager::SetRasterizerState(CullMode cullMode)
{
	DX11::Context()->RSSetState(m_RasterizerStates[cullMode].Get());
}

void Alpine::RenderStateManager::SetBlendState(BlendMode blendMode)
{
	DX11::Context()->OMSetBlendState(m_BlendStates[blendMode].Get(), nullptr, 0xFFFFFFFF);
}

void Alpine::RenderStateManager::SetDepthStencilState(DepthStencilMode depthStencilMode)
{
	DX11::Context()->OMSetDepthStencilState(m_DepthStencilStates[depthStencilMode].Get(), 0);
}
